...
set output "hp_with_experiment.eps"
set xlabel "pressure, kbar"
set ylabel "atom position, a. u."
plot [x=1:2000] [0:12] "hp.data" using 1:3 with lines title "Ca", "hp.data" using 1:4 with lines title "O", "hp.data" using 1:5 with lines title "H", \
